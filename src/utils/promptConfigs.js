...
祈福點燈、消災延壽，讓神明的靈光持續護佑您的日常 ➔ [此處自動帶入廟方數位功德箱/點燈連結]
 ...
 #${ctx.theme} [請再補充 3-5 個相關的 Hashtags]`
  }
];

export const getThemePrompts = (themeId) => {
  // 另外四個角色陸續再補，目前先 fallback 到 creator
  return CREATOR_PROMPTS;
};

export const WORKFLOW_STEPS = CREATOR_PROMPTS;
