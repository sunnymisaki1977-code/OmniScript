        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <a href="/" className="flex-1 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white font-bold py-3 px-4 rounded-xl transition-colors text-center">
                先去玩玩看 Demo
              </a>
            </div>
          </form>
